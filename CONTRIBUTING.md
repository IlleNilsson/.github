...
Repository placement is governed by [`xmip-architecture.json`](https://github.com/IlleNilsson/Xmip/blob/main/xmip-architecture.json). New repositories, dependencies and technology implementations must fit the classification and dependency rules in that manifest.
